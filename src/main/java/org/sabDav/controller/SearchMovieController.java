...
public class SearchMovieController {
    ...
    public ModelAndView AdvancedSearchForm() {		
		ModelAndView modelAndView = new ModelAndView();	
		FormModel form = new FormModel();
		modelAndView.addObject("form", form);
		modelAndView.setViewName("/components/movie/advancedSearch");
		return modelAndView;
    }//AdvancedSearchForm

	@RequestMapping(value="search/advanced", method = RequestMethod.POST)
	public ModelAndView AdvancedSearchSubmit(@Valid @ModelAttribute("form") FormModel form, BindingResult result, 
